...
//             this.generateDocuXml = this.generateDocuXml.bind(this)
//             this.generateFeatureAnalysisInfo = this.generateFeatureAnalysisInfo.bind(this)
//             this.generateDocUserTagging = this.generateDocUserTagging.bind(this)
//             this.generateMetadataFieldSettings = this.generateMetadataFieldSettings.bind(this)
//             this.parseUserDefinedTag = this.parseUserDefinedTag.bind(this)
//       }
//       generateDocuXml({selectedDocList, db, corpus, spotlights, featureAnalysisSettings}) {
//             let documentXml = ''
//             this.db = db
//             this.corpus = corpus
//             this.spotlights = spotlights
